...
static int hx_panel_coords[4] = {0, 1080, 0, 2340};
...
static char *himax_get_tp_firmware_version(void)
{
	int ret=0;
	u8 fwversion=0;

    fwversion = (u8)ic_data->vendor_touch_cfg_ver;
    I("Firmware version: 0x%4.4x\n", ic_data->vendor_touch_cfg_ver);
...
static struct tpd_driver_t tpd_device_driver = {
	...
	.get_tp_firmware_version= himax_get_tp_firmware_version,
