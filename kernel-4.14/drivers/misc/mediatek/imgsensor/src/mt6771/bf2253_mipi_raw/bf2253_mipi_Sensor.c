...
#include "bf2253_mipi_Sensor.h"
#ifdef XUNHU_LPS_TEKHW_SUPPORT
#include <teksunhw.h>/*add by xunhu andy andy20160720 at 22:49*/
static int tekhw_bf2253_mirror = 0xff;/*add by xunhu andy andy20160720 at 22:48*/
static int tekhw_bf2253_color =0xff;
static int tekhw_times=0;
#endif

/************************** Modify Following Strings for Debug **************************/
#define PFX "bf2253__camera_sensor"
#define LOG_1 LOG_INF("BF2253, MIPI 1LANE\n")
/****************************   Modify end    *******************************************/
	...
	MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	preview_setting();
#ifdef XUNHU_LPS_TEKHW_SUPPORT
    if (0xff != tekhw_bf2253_mirror)
    {
	    set_mirror_flip(tekhw_bf2253_mirror);
    }
#endif
	return ERROR_NONE;
}
...
{
    tekhw_camera_data* tekhw_bf2253_ptr = tekhw_get_appointed_camera_ptr(SENSOR_DRVNAME_BF2253_MIPI_RAW);/*add by xunhu andy andy20160720 at 22:56*/
    if ((tekhw_bf2253_ptr != NULL) && (tekhw_bf2253_ptr->set_mirror.size > 0))
    {
        tekhw_bf2253_mirror = *(tekhw_u16*)tekhw_bf2253_ptr->set_mirror.buffer;
    }
    if ((tekhw_bf2253_ptr != NULL) && (tekhw_bf2253_ptr->set_color.size > 0))
    {
		tekhw_bf2253_color= *(tekhw_u16*)tekhw_bf2253_ptr->set_color.buffer;
    }
}
#endif
	...
	MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	if(tekhw_bf2253_color !=0xff)
	{
		sensor_info->SensorOutputDataFormat = tekhw_bf2253_color;
	}
	tekhw_times=1;
#endif
...
UINT32 BF2253_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
