...
#include <linux/slab.h>//liuying add for kzalloc
...
/*Gionee <BUG> <shenweikun> <2017-9-4> add for GNSPR #107892 begin*/
#define NON_CONTINUE_MODE
//Chenyee xionggh 20180202 modify for crop align center begin
#define CROP_ALIGN_CENTER 1
//Chenyee xionggh 20180202 modify for crop align center end

#ifdef NON_CONTINUE_MODE
#define shutter1_30 3486
#define shutter1_15 6973
#define shutter1_8 13946
#define shutter1_4 27892
#define shutter1_2 55784
#define shutter1 111569
#define shutter2 223139
#define shutter3 334709
#define shutter4 446279
#define shutter6 669418
#define shutter8 892558
#define shutter10 1115697
#define shutter12 1338837

#define ccu_shutter1_30 3682
#define ccu_shutter1_15 7364
#define ccu_shutter1_8 13947
#define ccu_shutter1_4 27894
#define ccu_shutter1_2 55788
#define ccu_shutter1 111576
#define ccu_shutter2 223152
#define ccu_shutter3 334728
#define ccu_shutter4 446304
#define ccu_shutter6 669456
#define ccu_shutter8 892608
#define ccu_shutter10 1115760
#define ccu_shutter12 1338912
...
#endif
/*Gionee <BUG> <shenweikun> <2017-9-4> add for GNSPR #107892 end*/
...
static struct imgsensor_info_struct imgsensor_info = {
  ...
  .cap2 = {
	...
	.hs_video = {
		.pclk = 160000000,											//record different mode's pclk
		.linelength = 1386,		/*OV16885 Note: linelength/4,it means line length per lane*/
...
{{ 4704, 3536,     32,   24, 4640, 3488, 2320, 1744,  8, 8,  2304, 1728,     0,    0, 2304, 1728}, // Preview 
 ...
 { 4704, 3536,     32,   24, 4640, 3488, 2320, 1744,  8, 8,  2304, 1728,     0,    0, 2304, 1728},
 { 4704, 3536,     32,   24, 4640, 3488, 2320, 1744,  8, 8,  2304, 1728,     0,    0, 2304, 1728},
 { 4704, 3536,     32,   24, 4640, 3488, 2320, 1744,  8, 8,  2304, 1728,     0,    0, 2304, 1728},
 { 4704, 3536,     32,   24, 4640, 3488, 2320, 1744,  8, 8,  2304, 1728,     0,    0, 2304, 1728},
 { 4704, 3536,     32,   24, 4640, 3488, 2320, 1744,  8, 8,  2304, 1728,     0,    0, 2304, 1728}
...
/*Gionee <BUG> <shenweikun> <2017-9-9> add for GNSPR #92453 begin*/
static kal_uint16 long_shutter_flag = 0;
//static kal_uint16 long_shutter_flag2 = 0;
#if 0
static void long_shutter_exit(void)
{
	long_shutter_flag = 0;
	long_shutter_flag2 = 0;
	LOG_INF("shenweikun exit\n");

}
/*Gionee <BUG> <shenweikun> <2017-9-9> add for GNSPR #92453 end*/
#endif
 ...
 // Gionee wanguocheng added for fixing rolling-flicker at 20160530 ---End
	...
	switch(shutter)
	{
		 ...
		 case ccu_shutter1_15:
			...
			write_cmos_sensor_8(0x3500,0x01);
			write_cmos_sensor_8(0x3501,0xd0);
			write_cmos_sensor_8(0x3502,0xe0);
			write_cmos_sensor_8(0x3208,0x10);
			write_cmos_sensor_8(0x3208,0xa0);
			break;
		 case shutter1_8:
		 case ccu_shutter1_8:
			...
			write_cmos_sensor_8(0x380c,0x05);
			write_cmos_sensor_8(0x380d,0x9a);
			write_cmos_sensor_8(0x380e,0x36);
			write_cmos_sensor_8(0x380f,0x87);
			write_cmos_sensor_8(0x3500,0x03);
			write_cmos_sensor_8(0x3501,0x67);
			write_cmos_sensor_8(0x3502,0xb0);
			write_cmos_sensor_8(0x3208,0x10);
			write_cmos_sensor_8(0x3208,0xa0);
			break;
		 case shutter1_4:
		 case ccu_shutter1_4:
			...
			write_cmos_sensor_8(0x380c,0x05);
			write_cmos_sensor_8(0x380d,0x9a);
			write_cmos_sensor_8(0x380e,0x6d);
			write_cmos_sensor_8(0x380f,0x02);
			write_cmos_sensor_8(0x3500,0x06);
			write_cmos_sensor_8(0x3501,0xcf);
			write_cmos_sensor_8(0x3502,0x60);
			write_cmos_sensor_8(0x3208,0x10);
			write_cmos_sensor_8(0x3208,0xa0);
			break;
		 case shutter1_2:
		 case ccu_shutter1_2:
			...
			write_cmos_sensor_8(0x380c,0x05);
			write_cmos_sensor_8(0x380d,0x9a);
			write_cmos_sensor_8(0x380e,0xd9);
			write_cmos_sensor_8(0x380f,0xf8);
			write_cmos_sensor_8(0x3500,0x0d);
			write_cmos_sensor_8(0x3501,0x9e);
		 ...
		 case ccu_shutter1:
			...
			write_cmos_sensor_8(0x380d,0x90);
			write_cmos_sensor_8(0x380e,0xff);
			write_cmos_sensor_8(0x380f,0xff);
			write_cmos_sensor_8(0x3500,0x0f);			
			write_cmos_sensor_8(0x3501,0xfe);
			write_cmos_sensor_8(0x3502,0xd0);
			write_cmos_sensor_8(0x3208,0x10);
			write_cmos_sensor_8(0x3208,0xa0);
			break;
		 case shutter2:
		 case ccu_shutter2:
			...
			write_cmos_sensor_8(0x380d,0x12);
			write_cmos_sensor_8(0x380e,0xff);
			write_cmos_sensor_8(0x380f,0xff);
			write_cmos_sensor_8(0x3500,0x0f);			
			write_cmos_sensor_8(0x3501,0xfe);
		 ...
		 case ccu_shutter3:
			...
			long_shutter_flag = 1;
			write_cmos_sensor_8(0x3208,0x00);
			write_cmos_sensor_8(0x380c,0x1c);
			write_cmos_sensor_8(0x380d,0x9c);
			write_cmos_sensor_8(0x380e,0xff);
			write_cmos_sensor_8(0x380f,0xff);
			write_cmos_sensor_8(0x3500,0x0f);			
			write_cmos_sensor_8(0x3501,0xfe);
		 ...
		 case ccu_shutter4:
			...
			long_shutter_flag = 1;
			write_cmos_sensor_8(0x3208,0x00);
			write_cmos_sensor_8(0x380c,0x26);
			write_cmos_sensor_8(0x380d,0x25);
			write_cmos_sensor_8(0x380e,0xff);
			write_cmos_sensor_8(0x380f,0xff);
			write_cmos_sensor_8(0x3500,0x0f);			
			write_cmos_sensor_8(0x3501,0xfe);
		 ...
		 case ccu_shutter6:
			...
			long_shutter_flag = 1;
			write_cmos_sensor_8(0x3208,0x00);
			write_cmos_sensor_8(0x380c,0x39);
			write_cmos_sensor_8(0x380d,0x38);
			write_cmos_sensor_8(0x380e,0xff);
			write_cmos_sensor_8(0x380f,0xff);
			write_cmos_sensor_8(0x3500,0x0f);			
			write_cmos_sensor_8(0x3501,0xfe);
		 ...
		 case ccu_shutter8:
			...
			long_shutter_flag = 1;
			write_cmos_sensor_8(0x3208,0x00);
			write_cmos_sensor_8(0x380c,0x4c);
			write_cmos_sensor_8(0x380d,0x4b);
			write_cmos_sensor_8(0x380e,0xff);
			write_cmos_sensor_8(0x380f,0xff);
			write_cmos_sensor_8(0x3500,0x0f);			
			write_cmos_sensor_8(0x3501,0xfe);
		...
		case ccu_shutter10:
		   ...
		   long_shutter_flag = 1;
			write_cmos_sensor_8(0x3208,0x00);
			write_cmos_sensor_8(0x380c,0x5f);
			write_cmos_sensor_8(0x380d,0x5e);
			write_cmos_sensor_8(0x380e,0xff);
			write_cmos_sensor_8(0x380f,0xff);
			write_cmos_sensor_8(0x3500,0x0f);			
			write_cmos_sensor_8(0x3501,0xfe);
		 ...
		 case ccu_shutter12:
			...
			long_shutter_flag = 1;
			write_cmos_sensor_8(0x3208,0x00);
			write_cmos_sensor_8(0x380c,0x72);
			write_cmos_sensor_8(0x380d,0x72);
			write_cmos_sensor_8(0x380e,0xff);
			write_cmos_sensor_8(0x380f,0xff);
			write_cmos_sensor_8(0x3500,0x0f);			
			write_cmos_sensor_8(0x3501,0xfe);
		 ...
		 default:	
		 	...
		 	{
		 		write_cmos_sensor_8(0x380c, 0x05);
				write_cmos_sensor_8(0x380d, 0xc8);
				write_cmos_sensor_8(0x380e, 0x0e);
				write_cmos_sensor_8(0x380f, 0x8f);
				long_shutter_flag = 0;
		 	}
...
static void capture_setting(kal_uint16 currefps)
{
	...
	else if(currefps==301) // PIP
		pip_capture_setting();
	else if(currefps==301)
...
static void hs_video_setting(void)
{
	...
	*/
	...
	write_cmos_sensor_8(0x380c, 0x05);
	write_cmos_sensor_8(0x380d, 0x6A);
	...
	write_cmos_sensor_8(0x5000, 0xa1);
	write_cmos_sensor_8(0x5001, 0x46);
	write_cmos_sensor_8(0x57ff, 0x89);
	write_cmos_sensor_8(0x583e, 0x05);
...
#define OTP_DRV_START_ADDR  			0x6010
...
{
	//int i = 0;
	int nFlagAddress = 0x6010; //OTP_DRV_START_ADDR;
	int start_addr = 0, end_addr = 0;

//	int temp1;
	start_addr = nFlagAddress; //+1+(index-1)*OTP_DRV_INFO_SIZE;
	end_addr   = nFlagAddress + 4; //start_addr+OTP_DRV_INFO_SIZE-1;

	//write_cmos_sensor_8(0x3d84,0xC0);

	//partial mode OTP write start address
	//write_cmos_sensor_8(0x3d88,0x60);
	//write_cmos_sensor_8(0x3d89,0x10);
	//partial mode OTP write end address
	//write_cmos_sensor_8(0x3d8A,0x63);
	//write_cmos_sensor_8(0x3d8B,0x8f);

	//read otp into buffer
	//write_cmos_sensor_8(0x3d81,0x01);

	mdelay(50);
	(*otp_ptr).module_integrator_id = read_cmos_sensor_8(start_addr);
	(*otp_ptr).lens_id = read_cmos_sensor_8(start_addr+1);
	(*otp_ptr).vcm_id = read_cmos_sensor_8(start_addr+2);
	(*otp_ptr).vcm_driver_id = read_cmos_sensor_8(start_addr+3);
	(*otp_ptr).otp_mapping_id = read_cmos_sensor_8(start_addr+4);
	LOG_INF("Mid=%x lens_id=%x vcm_id=%x vcm_driver_id=%x (*otp_ptr).otp_mapping_id=%x\n",(*otp_ptr).module_integrator_id,(*otp_ptr).lens_id,(*otp_ptr).vcm_id,(*otp_ptr).vcm_driver_id,(*otp_ptr).otp_mapping_id);
		...
		do {	
			*sensor_id = (read_cmos_sensor_8(0x300A) << 16) | (read_cmos_sensor_8(0x300B)<<8) | (read_cmos_sensor_8(0x300C));
			if (*sensor_id == imgsensor_info.sensor_id) {
				printk("ov16885 Read sensor id ok, i2c write id: 0x%x, sensor id: 0x%x\n",imgsensor.i2c_write_id, *sensor_id);
				sensor_init();//set SCLK for OV13850
	            module_id=read_module_info(1,otp_ptr1);
				printk("ov16885 module_id=0x%x\n",module_id);
				if(module_id != 0x10)
				{
			...
			printk("ov16885 Read sensor id fail:i2c write id:0x%x,sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
			retry--;
		} while(retry > 0);
		i++;
		retry = 1;
					  ...
					  MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	sensor_info->PDAF_Support = 0; //PDAF_SUPPORT_RAW;
